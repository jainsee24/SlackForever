...
<p align="center">
  <img src="screenshot.png" alt="SlackForever Screenshot" width="100%" style="border-radius:8px;border:1px solid #ddd">
</p>
...
Download the latest **DMG** from [Releases](https://github.com/jainsee24/SlackForever/releases), drag to Applications, double-click. **No Python, no terminal, no setup needed.**

### From Source (Linux / Windows / macOS)
```bash
git clone https://github.com/jainsee24/SlackForever.git
cd SlackForever
./setup.sh
...
python desktop.py    # Opens in a native app window
```
...
├── desktop.py               # Native desktop app (pywebview)
├── build-dmg.sh             # Build standalone macOS DMG
