    ...
    textEl.innerHTML = `
        <div class="edit-message-container">
            ...
            <div class="edit-message-actions">
                ...
                <button class="btn-edit-save" onclick="saveEditMessage('${ts}')">Save</button>
            </div>
        </div>
    `;
...
function selectMentionItem(item) {
    ...
    if (matchStart >= 0) {
        // Show @DisplayName in textarea (looks nice)
        ...
        // Store the mapping so we can convert back when sending
